...
class OnboardingContainer extends React.Component {
  render(){
    ...
    const fillPercent = Math.round( (onboardingStep - 2) * 100 / 3 , 10)
    return(
            ...
            <div className="signup__progress">
              <div className="signup__progress-line">
                <div className="signup__progress-fill" style={{"width" : fillPercent + "%"}}>
                  <div className={"signup__progress-name " + (onboardingStep === 4 ? "signup__progress-name--last" : "")}>Step {onboardingStep - 2} of 3</div>
                </div>
              </div>
            </div>
          }
